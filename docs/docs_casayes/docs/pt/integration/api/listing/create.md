...
**Descrição:** Pedido para criação de um imóvel utilizando o esquema fornecido.

**Method  `POST`**

**Headers**

<table><thead><tr><th width="238">Nome</th><th width="126">Tipo</th><th>Descrição</th></tr></thead><tbody><tr><td><code>Authorization</code></td><td><code>string</code></td><td>Token Bearer utilizado para autenticar o seu pedido à API. Inclua o token no formato  <code>Bearer YOUR_API_KEY</code>.</td></tr><tr><td><code>office-integration-secret</code></td><td><code>string</code></td><td>Segredo de integração para uma determinada agência</td></tr></tbody></table>

**Body application/json** [**Modelo do Imóvel**](../../schemas/imovel.md)
...
#### `api/v1/Listing/upload`

**Descrição**: Carregue um ficheiro que contenha vários imóveis a serem criados utilizando o esquema fornecido.

**Method** **`POST`**

**Headers**

<table><thead><tr><th width="239">Nome</th><th width="124">Tipo</th><th>Descrição</th></tr></thead><tbody><tr><td><code>Authorization</code></td><td><code>string</code></td><td>Token Bearer utilizado para autenticar o seu pedido à API.<br>Inclua o token no formato  <code>Bearer YOUR_API_KEY</code>.</td></tr><tr><td><code>office-integration-secret</code></td><td><code>string</code></td><td>Segredo de integração para uma determinada agência</td></tr></tbody></table>

**Body multipart/form-data `{ "OfficeIntegrationSecret": "string", "Listings": [`** [**Modelo do Imóvel**](../../schemas/imovel.md) **`] }`**
...
Body:
"OfficeIntegrationSecret": "003_16623336828_5FB1148E-8E71-4CA1-2N89-B3F195882817",
"Listings": [
{
"type": "Apartment",
    "reference": "20240806-0957",
