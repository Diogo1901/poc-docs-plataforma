...
**Description**: Request for a listing to be created using the provided schema.

**Method `POST`**

**Headers**

<table><thead><tr><th width="238">Name</th><th width="126">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>Authorization</code></td><td><code>string</code></td><td>Bearer token used to authenticate your API request. Include the token in the format <code>Bearer YOUR_API_KEY</code>.</td></tr><tr><td><code>office-integration-secret</code></td><td><code>string</code></td><td>Integration secret for a given office.</td></tr></tbody></table>
...
**Description**: Upload a file containing several listings to be created using the provided schema.

**Method `POST`**

**Headers**

<table><thead><tr><th width="239">Name</th><th width="124">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>Authorization</code></td><td><code>string</code></td><td>Bearer token used to authenticate your API request. Include the token in the format <code>Bearer YOUR_API_KEY</code>.</td></tr><tr><td><code>office-integration-secret</code></td><td><code>string</code></td><td>Integration secret for a given office.</td></tr></tbody></table>

**Body multipart/form-data `{ "OfficeIntegrationSecret": "string", "Listings": [`** [**ListingModel**](../../schemas/listing-schema.md) **`] }`**
